...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-gray-500">
    <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div className='max-w-80'>

            <img className="w-34 md:w-32" src={assets.logo} alt="logo" />
            <p className="max-w-[410px] mt-6">Transform your space without the high upfront cost. Rent quality furniture and home appliances with flexible plans and reliable doorstep delivery.</p>
        </div>
